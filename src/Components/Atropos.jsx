...
function ProjectCard({ project }) {
  ...
  return (
    ...
    >
      ...
      >
        <section className="bg-gray-100 w-[23rem] md:w-[34rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[17rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
          ...
          <div className="absolute opacity-30 sm:opacity-90 rounded-md top-8 -right-40 w-[28.25rem] rounded-t-lg shadow-2xl">
