    ...
    <header className="fixed top-0 left-0 z-50 w-full h-[50px] md:mx-auto dark:text-white opacity-[4px]">
      ...
      <nav
        className={` text-white absolute top-full ${
          isShowNav ? "left-0 z-50 min-h-screen dark:text-white" : "-left-full"
      ...
      >
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "text-red-500 hover:border-b-4 border-black hover:bg-blue-300 rounded-md tracking-widest p-1 duration-200 transition-all dark:border-white"
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "ext-whitedark:t text-red-500 hover:border-b-4 border-black hover:bg-blue-300 rounded-md tracking-widest p-1 duration-200 transition-all dark:border-white"
