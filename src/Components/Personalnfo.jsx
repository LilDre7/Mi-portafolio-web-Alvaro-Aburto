  ...
  return (
    <section className="m-6 relative mt-[-6rem] dark:bg-[#202023] dark:text-white">
      <div className="my_info text-center bg-[#e0d8cfa5] p-3 rounded-lg md:max-w-[70%] md:mx-auto md:text-lgdark:text-white">
        <p>Hola, soy Alvaro soy desarrollador de software en Costa Rica!</p>
      </div>
      <article className="flex flex-col mt-3">
        ...
        <button className="flex items-center mt-6 p-3 rounded-xl text-white bg-emerald-500 max-w-[10rem] mx-auto hover:bg-emerald-950 transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-lg shadow-black/50  ">
          {" "}
          Mi Portafolio
